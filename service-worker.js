const CACHE = 'naam-jap-v33-final';
const ASSETS = ['./','./index.html','./style.css?v=33','./app.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-512-maskable.png'];
