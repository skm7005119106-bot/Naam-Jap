const CACHE = 'naam-jap-v31-divine';
const ASSETS = ['./','./index.html','./style.css?v=31','./app.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-512-maskable.png'];
