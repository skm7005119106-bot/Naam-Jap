const CACHE = 'naam-jap-v32-fullscreen-premium';
const ASSETS = ['./','./index.html','./style.css?v=32','./app.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-512-maskable.png'];
