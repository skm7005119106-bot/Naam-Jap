...
const BN_NAMES={
 radha:"রাধা","radhe":"রাধে রাধে","shri-radha":"শ্রী রাধা","krishna":"কৃষ্ণ","govind":"গোবিন্দ","gopal":"গোপাল","shyam":"শ্যাম","madhav":"মাধব","hari":"হরি","ram":"রাম","shri-ram":"শ্রী রাম","siyaram":"সিয়ারাম","om":"ওঁ","om-namah-shivaya":"ওঁ নমঃ শিবায়","shiv":"শিব","mahadev":"মহাদেব","narayan":"নারায়ণ","hare-krishna":"হরে কৃষ্ণ হরে কৃষ্ণ","hare-rama":"হরে রাম হরে রাম","full-mahamantra":"হরে কৃষ্ণ হরে কৃষ্ণ, কৃষ্ণ কৃষ্ণ হরে হরে\nহরে রাম হরে রাম, রাম রাম হরে হরে"
};
const I={
 en:{
 ...
 hi:{
  ...
  selectedNaam:"Chuna hua Naam",todayJap:"Aaj ka Jap",mala:"Mala",startJap:"Jap shuru karein",totalJap:"Kul Jap",totalMala:"Kul Mala",goal:"Vartaman Sankalp",dailySmaran:"Aaj ka Smaran",beforeJap:"Jap se pehle",japWith:"Jap",back:"Wapas",undo:"Undo",pause:"Rokein",finish:"Samapt",reminder:"Smaran",countReminder:"Ginti se zyada bhav aur niyamit Naam Smaran par dhyan dein.",myNaam:"Mere Naam",addNaam:"Joden",sankalp:"Sankalp",goalNaam:"Jap Naam",target:"Lakshya Jap",deadline:"Antim din (optional)",saveGoal:"Sankalp save karein",history:"Sadhana History",export:"Export",certificate:"Certificates",settings:"Settings",language:"Bhasha",defaultNaam:"Default Jap Naam",tapGuard:"Tez tap suraksha",volumeNote:"Volume buttons",volumeNoteText:"Web preview mein Android volume keys reliably capture nahi hote. Native Android version mein baad mein bridge add kiya ja sakta hai.",data:"Local Data",dataText:"Is MVP ka practice data isi device/browser mein rehta hai.",reset:"Sabhi local data reset karein",home:"Home",naam:"Naam",naamJap:"Jap",profile:"Profile",myProfile:"Mera Profile",edit:"Badlein",summary:"Saar",daysPracticed:"Din",naamSummary:"Naam Jap Saar",goalSummary:"Sankalp Saar",profileName:"Aapka naam",saveProfile:"Profile Save Karein",sound:"Jap Sound",soundOn:"Sound On",soundOff:"Sound Off",profileHint:"Aapka profile isi device par save rahega.",certificateSystem:"Certificate Milestones",certificateSystemText:"Required Naam Jap sach mein poora hone par certificate automatically unlock hoga.",certificateProgress:"Certificate Progress",unlocked:"Unlock ho gaya",remaining:"baaki",nextCertificate:"Agla certificate",customNaamHint:"Apna Jap Naam khud likhein",customNaamHintText:"Radha, Krishna, Ram ya apna koi bhi Naam add karke alag counter rakhein.",theme:"Theme",support:"Help & Support",supportText:"Naam Jap, sound, backup, certificate aur settings ke liye basic help.",openSupport:"Support kholen",openSankalp:"Sankalp",openSettings:"Settings"
 }
};


I.bn={
 welcome:"Naam Jap ke liye ek saral offline saathi.",
 chooseLanguage:"Apni bhasha chunun", chooseNaam:"Apnar Jap Naam bachun", continue:"Egiye jan", changeLater:"Ei settings poreo bodlate parben.",
 selectedNaam:"Bachai kora Naam", todayJap:"Aajker Jap", mala:"Mala", startJap:"Jap shuru korun", totalJap:"Mot Jap", totalMala:"Mot Mala", goal:"Bartoman Sankalp",
 dailySmaran:"Aajker Smaran", beforeJap:"Jap-er age", japWith:"Jap", back:"Phire jan", undo:"Undo", pause:"Thaman", finish:"Shesh korun",
 reminder:"Smaran", countReminder:"Shudhu ginti noy, bhav o niyomito Naam Smaran-er dike mon din.",
 myNaam:"Amar Naam", addNaam:"Jog korun", customNaamHint:"Apnar Jap Naam nijer moto likhun", customNaamHintText:"Radha, Krishna, Ram ba apnar pochonder Naam jog kore alada counter rakhun.",
 sankalp:"Sankalp", goalNaam:"Jap Naam", target:"Target Jap", deadline:"Shesh tarikh (optional)", saveGoal:"Sankalp Save korun",
 history:"Sadhana History", export:"Backup Export", certificate:"Certificate", settings:"Settings", language:"Bhasha", defaultNaam:"Default Jap Naam", tapGuard:"Druto tap suraksha",
 volumeNote:"Volume buttons", volumeNoteText:"Web preview-e Android volume key nischit bhabe dhora jay na. Native Android version-e pore ei support jog kora jabe.",
 data:"Local Data", dataText:"Ei app-er practice data ei device/browser-e thake.", reset:"Shob local data reset korun", home:"Home", naam:"Naam", naamJap:"Jap", profile:"Profile",
 myProfile:"Amar Profile", edit:"Poriborton", summary:"Saar", daysPracticed:"Din", naamSummary:"Naam Jap Saar", goalSummary:"Sankalp Saar", profileName:"Apnar naam", saveProfile:"Profile Save korun",
 sound:"Jap Sound", soundOn:"Sound On", soundOff:"Sound Off", profileHint:"Apnar profile ei device-e save thakbe.", certificateSystem:"Certificate Milestones",
 certificateSystemText:"Proyojonio Naam Jap shotti poora hole certificate automatically unlock hobe.", certificateProgress:"Certificate Progress", unlocked:"Unlock hoyeche", remaining:"baki", nextCertificate:"Porer certificate",
 theme:"Theme", support:"Help & Support", supportText:"Naam Jap, sound, backup, certificate ba settings niye basic help ekhane paben.", openSupport:"Support khulun", openSankalp:"Sankalp", openSettings:"Settings"
};
...
function defaultState(){return {version:7,onboarded:false,lang:"hi",selected:"radhe",customNaams:[],favourites:[],counts:{},daily:{},sessions:[],goals:[],certificates:[],profile:{name:"",joined:todayKey()},settings:{tapGuard:"strict",sound:true,tapSound:true,malaSound:true,soundVolume:55,theme:"divine",haptic:true,wakeLock:false},milestoneCertificates:{}}}
...
function displayNaam(n){if(state.lang==="hi")return n.hi;if(state.lang==="bn")return n.bn||BN_NAMES[n.id]||n.en;return n.en}
...
function t(k){return ((I[state.lang]||I.hi)[k]||I.hi[k]||I.en[k]||k)}
...
function renderCertificates(){const el=document.getElementById("certificateList");el.innerHTML=state.certificates.length?state.certificates.slice().reverse().map(c=>{const naamLabel=c.naamId?displayNaam(naamObj(c.naamId)):(state.lang==="hi"?"Naam Jap":"Naam Jap");return `<div class="cert-item"><div class="cert"><div class="cert-lotus">ॐ</div><h3>Naam Jap<br>Completion Certificate</h3><p class="cert-intro">This acknowledges completion of a self-recorded Naam Jap practice.</p><p class="cert-line">${state.lang==="hi"?"Yeh certificate hai":"This certifies that"}</p><p class="cert-user-name"><b>${escapeHtml(state.profile.name||"Naam Sadhak")}</b></p><p class="cert-line">${state.lang==="hi"?"ne poora kiya":"has completed"}</p><div class="cert-count-big">${c.target.toLocaleString()} <span>Jap</span></div><p class="cert-line">${state.lang==="hi"?"ka":"of"}</p><div class="cert-naam-pill">Jap ${escapeHtml(naamLabel)}</div><p class="tiny">Completed: ${c.date}</p><p class="tiny">Milestone: ${c.milestoneId?((CERT_MILESTONES.find(m=>m.id===c.milestoneId)?.titleEn)||"Sankalp"):"Sankalp"}</p><p class="cert-num">Certificate ID: ${c.id}</p><button class="secondary small printCert" data-id="${c.id}">${state.lang==="hi"?"Print / Save PDF":"Print / Save PDF"}</button></div></div>`}).join(""):`<div class="card muted">${state.lang==="hi"?"Target poora hone par certificate yahan milega.":"Completed target certificates will appear here."}</div>`;el.querySelectorAll(".printCert").forEach(b=>b.onclick=()=>printCertificate(b.dataset.id))}
...
function acceptTap(){
 ...
 session.lastTap=now;
 if(state.settings.haptic!==false && navigator.vibrate)navigator.vibrate(10);
 session.count++;
 session.history.push(1);
 addCount(state.selected,1);
 japSound("tap");
 const jb=document.getElementById("japButton");
 if(jb){jb.classList.remove("tap-fx");void jb.offsetWidth;jb.classList.add("tap-fx")}
 ...
 if(newMala>session.lastMala){
   ...
   if(jb && newMala>0){jb.classList.remove("mala-fx");void jb.offsetWidth;jb.classList.add("mala-fx")}
   toast(state.lang==="hi"?`ॐ ${newMala} ${t("mala")} complete`:`ॐ Mala ${newMala} complete`);
 }
 save();
 render();
 renderSession();
...
function newCertificateId(kind){const stamp=Date.now().toString(36).toUpperCase();const rand=Math.random().toString(36).slice(2,8).toUpperCase();return `NJ-${kind}-${stamp}-${rand}`}
function checkMilestoneCertificates(){const total=totalAllJap();let unlocked=[];CERT_MILESTONES.forEach(m=>{if(total>=m.target&&!state.milestoneCertificates[m.id]){const id=newCertificateId(m.id.toUpperCase());const c={id,milestoneId:m.id,naamId:state.selected,target:m.target,date:todayKey(),totalAtCompletion:total};state.milestoneCertificates[m.id]=c;state.certificates.push(c);unlocked.push(m)}});if(unlocked.length){save();showMilestoneUnlocked(unlocked[unlocked.length-1])}}
function showMilestoneUnlocked(m){const latest=state.certificates[state.certificates.length-1];openModal(`<div class="celebration" style="text-align:center"><div class="celebration-mark">ॐ</div><div class="celebration-sparkles">✦  ✦  ✦</div><h2>${state.lang==="hi"?"Certificate Unlock हुआ":"Certificate Unlocked"}</h2><p><b>${state.lang==="hi"?m.titleHi:m.titleEn}</b></p><p>${m.target.toLocaleString()} Naam Jap complete</p><div class="celebration-naam">${displayNaam(naamObj(state.selected))}</div><p class="muted">${state.lang==="hi"?"Aapki sadhna ka digital certificate tayyar hai.":"Your digital certificate is ready."}</p><div class="row"><button id="openNewCert" class="primary">${state.lang==="hi"?"Certificate देखें":"View Certificate"}</button><button id="printNewCert" class="secondary">${state.lang==="hi"?"Print / PDF":"Print / PDF"}</button></div></div>`);document.getElementById("openNewCert").onclick=()=>{closeModal();showPage("profile");switchProfileTab("certificates")};document.getElementById("printNewCert").onclick=()=>printCertificate(latest.id)}
function checkGoalsForCertificate(){state.goals.forEach(g=>{if(g.active&&totalFor(g.naamId)>=g.target&&!state.certificates.some(c=>c.goalId===g.id)){g.active=false;const id=newCertificateId("SANKALP");state.certificates.push({id,goalId:g.id,naamId:g.naamId,target:g.target,date:todayKey()});showCertificateUnlocked(g)}})}
...
function showCertificateUnlocked(g){openModal(`<div style="text-align:center"><div style="font-size:48px">ॐ</div><h2>${state.lang==="hi"?"Sankalp poorn":"Sankalp Complete"}</h2><p>${displayNaam(naamObj(g.naamId))} · ${g.target.toLocaleString()} Jap</p><p class="muted">${state.lang==="hi"?"Aapka in-app completion certificate tayyar hai.":"Your in-app completion certificate is ready."}</p><button id="viewCert" class="primary wide">${state.lang==="hi"?"Certificate dekhein":"View Certificate"}</button></div>`);document.getElementById("viewCert").onclick=()=>{closeModal();showPage("profile");switchProfileTab("certificates")}}
function printCertificate(id){
 const c=state.certificates.find(x=>x.id===id);if(!c)return;
 const n=c.naamId?displayNaam(naamObj(c.naamId)):(state.lang==="hi"?"Naam Jap":"Naam Jap"); const milestoneTitle=c.milestoneId?(state.lang==="hi"?(CERT_MILESTONES.find(m=>m.id===c.milestoneId)?.titleHi||"Milestone"):(CERT_MILESTONES.find(m=>m.id===c.milestoneId)?.titleEn||"Milestone")):"Sankalp";
 ...
 *{box-sizing:border-box}
 ...
 <h1>Naam Jap</h1><h2>Completion Certificate</h2><h2 style="font-size:18px;color:#b45309">${milestoneTitle}</h2>
 ...
 <div class="naam-label">Jap Naam Jap: ${escapeHtml(n)}</div>
...
function init(){
 ...
 document.getElementById("themeSelect").onchange=e=>{state.settings.theme=e.target.value;save();applyTheme();render()};
 document.getElementById("hapticToggle").onclick=()=>{state.settings.haptic=state.settings.haptic===false;save();applyTheme();render()};
 document.getElementById("wakeToggle").onclick=()=>setWakeLock(!state.settings.wakeLock);
 ...
 document.getElementById("supportBtn").onclick=()=>openModal(`<h2>${t("support")}</h2><p>${t("supportText")}</p><div class="card"><b>Naam Jap</b><p class="muted">Counter: 1 tap = 1 accepted Jap. 108 Jap = 1 Mala.</p><p class="muted">Certificate: milestone ya Sankalp complete hone par unlock hota hai.</p><p class="muted">Backup: Profile → Export Backup se JSON backup save karein.</p><p class="muted">Theme: Settings → Light, Dark ya Divine.</p></div><button id="supportClose" class="primary wide">Close</button>`); document.getElementById("supportClose").onclick=closeModal;
